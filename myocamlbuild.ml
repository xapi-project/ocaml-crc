(* OASIS_START *)
(* DO NOT EDIT (digest: a76ab02d753be97ba714ca3c318b12aa) *)
...
let package_default =
  {
     ...
     flags =
       [
          ...
          (["oasis_library_crc_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_crc_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_crc_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_library_crc_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          ...
          (["oasis_executable_crc_test_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_executable_crc_test_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_executable_crc_test_native"; "ocaml"; "ocamldep"; "native"
           ],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_executable_crc_test_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])]);
          (["oasis_executable_crc_test_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-bin-annot"])])
       ];
     includes = [("test", ["lib"])]
  }
