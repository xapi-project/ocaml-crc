...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8567521e3d8427ecbc20153b631236c0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "CRC library for computing checksums of buffers and strings";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "crc_test.ml"});
               Test
                 ({
                     cs_name = "crc_test";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title =
                        "CRC library documentation and API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\208\165\142\021\027\233\235\001\153>\014\193\128\150\r0";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
